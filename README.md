<p align="center">
  <h1 align="center">Fundamentos do React.js</h1>
  <p align="center">Projeto desenvolvido durante a formação <strong>React.js</strong>.</p>
</p>

<p align="center">
  <img src="https://img.shields.io/github/repo-size/felipe-dr/fundamentals-web-react?style=for-the-badge&color=4e5acf" alt="Repo size" />
  <a aria-label="Last Commit" href="https://github.com/felipe-dr/fundamentals-web-react/commits/main">
    <img src="https://img.shields.io/github/last-commit/felipe-dr/fundamentals-web-react?style=for-the-badge&color=4e5acf" alt="Last commit on GitHub" />
  </a>
...
Aplicação de exibição de posts desenvolvida em React.js com o Vite e Typescript, afim de criar ou remover posts e seus comentários.

## Requisitos e funcionalidades

- [x] Deve ser possível adicionar um post;
- [x] Deve ser possível remover um post;
- [x] Deve ser possível adicionar um comentário em um post;
- [x] Deve ser possível remover um comentário em um post;
